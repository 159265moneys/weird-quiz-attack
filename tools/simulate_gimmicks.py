...
REGISTRY: List[Gimmick] = [
    ...
    # B22 (text-shadow) / B31 (opacity) は CSS のみ非破壊なので conflict なし。
    Gimmick('B22', '問題文二重見え',   'both', 5, 5),
    Gimmick('B23', '問題文黒塗り',     'both', 6, 7,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B24', 'B26', 'B27', 'B28', 'B29', 'B30']),
    Gimmick('B24', '問題文スクロール', 'both', 7, 7,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B23', 'B26', 'B27', 'B28', 'B29', 'B30']),
    Gimmick('B26', '問題文カラーバラ', 'both', 4, 4,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B23', 'B24', 'B27', 'B28', 'B29', 'B30']),
    Gimmick('B27', '問題文1文字欠落',  'both', 5, 5,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B23', 'B24', 'B26', 'B28', 'B29', 'B30']),
    Gimmick('B28', '問題文サイズ崩壊', 'both', 6, 6,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B23', 'B24', 'B26', 'B27', 'B29', 'B30']),
    Gimmick('B29', '問題文バウンド',   'both', 8, 9,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
                       'B23', 'B24', 'B26', 'B27', 'B28', 'B30']),
    Gimmick('B30', '問題文渦巻き',     'both', 8, 8,
            conflicts=['B02', 'B07', 'B10', 'B15', 'B17',
