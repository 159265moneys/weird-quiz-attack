...
(function () {
    ...
    function render(result, stageInfo, extras = {}) {
        ...
        const stageNo = stageInfo?.no;
        const pctText = window.Ranks?.percentileText(result.rank, stageNo) || '';
        const realLabel = window.Ranks?.pickLabel(result.rank, stageNo, extras.labelSeed) || '';
    ...
    function buildText(result, stageInfo, extras = {}) {
        ...
        const label = window.Ranks?.pickLabel(result.rank, stageInfo?.no, extras.labelSeed) || '';
